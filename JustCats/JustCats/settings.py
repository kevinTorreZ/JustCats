"""
Django settings for JustCats project.
...
SECRET_KEY = 'django-insecure-f)t$&3vrwg7)gcx9t*flqeupebv3m^5i8=n_##%rhp6n82ba6x'
...
WSGI_APPLICATION = 'JustCats.wsgi.application'
